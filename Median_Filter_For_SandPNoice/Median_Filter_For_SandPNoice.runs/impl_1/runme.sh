...
HD_PWD='H:/Median_Filter_For_SandPNoice/Median_Filter_For_SandPNoice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_component.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_component.tcl -notrace
