...
HD_PWD='H:/Median_Filter_For_SandPNoice/Median_Filter_For_SandPNoice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_component.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_component.tcl
